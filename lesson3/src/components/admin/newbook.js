import { useState, useEffect, debounce } from "../../ultilities";
const newBook = () => {
  useEffect(() => {
      ...
      <nav aria-label="breadcrumb" class="w-max">
        <ol class="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
          ...
          <li class="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
            <p class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">new book</p>
          </li>
        </ol>
      </nav>
    </div>
  ...
  <input   class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" type="text" >
  ...
  <input class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="original_price" type="text" >
  ...
  <textarea name="" id="short_description" cols="30" rows="10" class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white""></textarea>
  <p class="text-red-500 text-xs italic">Vui lòng nhập tên sách</p>
	</div>
  <div class="mb-3">
  ...
  <input class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="list_price" type="text" >
  ...
  <input class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="sale_price" type="text" >
...
<input class=" appearance-none block w-full  text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="rating_average" type="text" >
...
<input type="checkbox" name="" id="active" class="mx-1 mt-[1px]" checked>
</div>
  </div>
  <button type="submit" class="inline-block rounded border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500">Thêm mới</button>
	</form>
</div>
    `;
};
